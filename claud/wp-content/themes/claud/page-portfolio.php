...
<div class="container-full">
            <div class="row">
                <div class="col-lg-12 text-center v-center contenidoCentral">
                    <h1><span>&#91;</span>CLAUD<span>&#93;</span></h1> 
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <div class="item">
                ...
                <a title="<?=$title?>: <?=$desc?>" 
                rel="lightbox[work]" 
                href="<?php print  portfolio_thumbnail_url($post->ID) ?>"><?php the_post_thumbnail(); ?>
                </a>
                <div "style:white">
                	<?php
					    $args = array(
               ...
               <div>
                ...
                <a title="<?=$title?>: <?=$desc?>" rel="lightbox[work]" href="<?php print  portfolio_thumbnail_url($post->ID) ?>">(more)</a></p>
